    ...
    <div class="container">
      <div class="row">
        <div class="px-lg-5 d-flex flex-column justify-content-center col-lg-6">
          ...
          <p class="mb-3 lead">Esta página sigue la metodología de Ramon Campayo para el aprendizaje de idiomas, la cual esta basada principalmente en la memorizacion, el siguiente video muestra a mas detalle dicho metodo.</p>
        </div>
        <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1>Una nueva metodologia de aprender Ingles</h1>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-md-4 p-4"> <img class="img-fluid d-block rounded-circle" src="{{URL::asset('webimages/303.png')}}">
          <h4><b>Entenderas la pronunciación de los demas</b></h4>
          <p>Incluso si tu vocabulario y gramatica son perfectos, puedes tener problemas para darte a entender por tu pronunciacion.<br>Aprender a pronunciar correctamente las palabras puede ser una de las partes más dificiles para dominar el Ingles. NOSOTROS TE AYUDAREMOS.</p>
        </div>
        <div class="col-md-4 col-6 p-4"> <img class="img-fluid d-block rounded-circle" src="{{URL::asset('webimages/304.png')}}">
          ...
          <p>Mejorar la escritura gramátical en ingles, pues es uno de los objetivos que muchas personas tienen al aprender el idioma. No importa que nivel tengas o cual sea el uso que le darás al idioma. Esta habilidad siempre te dara margen para seguir mejorando.</p>
        </div>
        <div class="col-md-4 col-6 p-4"> <img class="img-fluid d-block rounded-circle" src="{{URL::asset('webimages/305.png')}}">
          ...
          <p>Incluso los hablantes netos del idioma ingles, a veces tienen algunas dificultades para comunicarse. Los problemas en la comunicacion se dan cuando se pierde la conexión entre el hablante y el oyente. En un momento dado, la información se pierde o distorciona.<br></p>
        </div>
      </div>
